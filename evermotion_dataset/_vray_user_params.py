...
def _set_vray_user_params(renderer):
    ...
    settings_image_sampler.progressive_threshold  = 0.001 # recommended by Vlado @ Chaos Group for extra clean images
    settings_image_sampler.progressive_maxTime    = 300
    ...
    settings_light_cache.subdivs         = 1500
